...
export const SheetClose = React.forwardRef(({ className, children, ...props }, ref) => (
  <SheetPrimitive.Close ref={ref} className={cn("absolute top-4 right-4 z-50 flex items-center justify-center p-2 rounded-full hover:bg-slate-100 focus:outline-none", className)} {...props}>
...
export const SheetTitle = React.forwardRef(({className, ...props}, ref) => (
  <SheetPrimitive.Title ref={ref} className={cn("text-lg font-semibold text-slate-950 dark:text-slate-50", 
    className)} {...props} />
));
